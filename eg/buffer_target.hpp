...
class BufferTarget
  : public core::BufferTargetBase< BufferTarget< Target > >
{
public:
  constexpr GLenum target() const
  {
...
{
  using parent = core::BufferTargetBase< BufferTarget< GL_TRANSFORM_FEEDBACK_BUFFER > >;
public:
  using parent::bind;
  constexpr GLenum target() const
  {
...
constexpr BufferTarget< GL_TRANSFORM_FEEDBACK_BUFFER > transform_feedback_buffer{};
...
#define EG_BUFFER_BINDING_ENUM(a,b) \
  ...
  EG_BUFFER_BINDING_ENUM( GL_ELEMENT_ARRAY_BUFFER , GL_ELEMENT_ARRAY_BUFFER_BINDING );
  EG_BUFFER_BINDING_ENUM( GL_UNIFORM_BUFFER , GL_UNIFORM_BUFFER_BINDING );
  EG_BUFFER_BINDING_ENUM( GL_TRANSFORM_FEEDBACK_BUFFER , GL_TRANSFORM_FEEDBACK_BUFFER );
...
#if EG_GL_VERSION>=400 || defined(EG_ARB_DRAW_INDIRECT)
  EG_BUFFER_BINDING_ENUM( GL_DRAW_INDIRECT_BUFFER , GL_DRAW_INDIRECT_BUFFER_BINDING );
#endif
#if EG_GL_VERSION>=420 || defined(EG_ARB_SHADER_ATOMIC_COUNTERS)
  EG_BUFFER_BINDING_ENUM( GL_ATOMIC_COUNTER_BUFFER , GL_ATOMIC_COUNTER_BUFFER_BINDING );
#endif
#if EG_GL_VERSION>=430 || defined(EG_ARB_SHADER_STORAGE_BUFFER_OBJECT)
  EG_BUFFER_BINDING_ENUM( GL_SHADER_STORAGE_BUFFER , GL_SHADER_STORAGE_BUFFER_BINDING );
#endif
